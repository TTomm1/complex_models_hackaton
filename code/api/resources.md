...
We are using "mix in" classes to achieve multiple inheritance: MyEstimator extends (and inherits methods from) both BaseEstimator and ClassifierMixin.
